...
import 'garage_page1_model.dart';
export 'garage_page1_model.dart';

class GaragePage1Widget extends StatefulWidget {
  const GaragePage1Widget({Key? key}) : super(key: key);

  @override
  _GaragePage1WidgetState createState() => _GaragePage1WidgetState();
}

class _GaragePage1WidgetState extends State<GaragePage1Widget> {
  late GaragePage1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GaragePage1Model());
