...
import 'timeslot_sunday_model.dart';
export 'timeslot_sunday_model.dart';

class TimeslotSundayWidget extends StatefulWidget {
  const TimeslotSundayWidget({
    Key? key,
    this.newGarageRef,
  }) : super(key: key);
  ...
  @override
  _TimeslotSundayWidgetState createState() => _TimeslotSundayWidgetState();
}

class _TimeslotSundayWidgetState extends State<TimeslotSundayWidget> {
  late TimeslotSundayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimeslotSundayModel());
  }
