...
import 'edit_garage_address_model.dart';
export 'edit_garage_address_model.dart';

class EditGarageAddressWidget extends StatefulWidget {
  const EditGarageAddressWidget({
    Key? key,
    this.garage,
  }) : super(key: key);
  ...
  @override
  _EditGarageAddressWidgetState createState() =>
      _EditGarageAddressWidgetState();
}

class _EditGarageAddressWidgetState extends State<EditGarageAddressWidget> {
  late EditGarageAddressModel _model;
