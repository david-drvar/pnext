...
import 'timeslot_wednesday_model.dart';
export 'timeslot_wednesday_model.dart';

class TimeslotWednesdayWidget extends StatefulWidget {
  const TimeslotWednesdayWidget({
    Key? key,
    this.newGarageRef,
  }) : super(key: key);
  ...
  @override
  _TimeslotWednesdayWidgetState createState() =>
      _TimeslotWednesdayWidgetState();
}

class _TimeslotWednesdayWidgetState extends State<TimeslotWednesdayWidget> {
  late TimeslotWednesdayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimeslotWednesdayModel());
  }
