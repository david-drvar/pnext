...
import 'create_garage2_model.dart';
export 'create_garage2_model.dart';

class CreateGarage2Widget extends StatefulWidget {
  const CreateGarage2Widget({Key? key}) : super(key: key);

  @override
  _CreateGarage2WidgetState createState() => _CreateGarage2WidgetState();
}

class _CreateGarage2WidgetState extends State<CreateGarage2Widget> {
  late CreateGarage2Model _model;
