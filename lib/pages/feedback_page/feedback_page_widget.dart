                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'i2k341wj' /* How was your overall experienc... */,
                                ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '3nekxady' /* Did you find the garage bookin... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'i2kkwgwb' /* How would you rate the design ... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'nt8ras6s' /* How would you rate the overall... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'ggdevzle' /* Did you encounter any difficul... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  's3lpbpc6' /* Would you recommend our garage... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'pc2hqv93' /* Is there any specific feature ... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelStyle:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  hintText: FFLocalizations.of(context).getText(
                                    '73xjhztn' /* Enter functionalities here... */,
                                  ),
                                  hintStyle:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                  enabledBorder: OutlineInputBorder(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'p0sbawzw' /* Feel free to put any additiona... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
