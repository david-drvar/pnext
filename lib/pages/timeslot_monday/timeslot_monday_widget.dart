...
import 'timeslot_monday_model.dart';
export 'timeslot_monday_model.dart';

class TimeslotMondayWidget extends StatefulWidget {
  const TimeslotMondayWidget({
    Key? key,
    this.newGarageRef,
  }) : super(key: key);
  ...
  @override
  _TimeslotMondayWidgetState createState() => _TimeslotMondayWidgetState();
}

class _TimeslotMondayWidgetState extends State<TimeslotMondayWidget> {
  late TimeslotMondayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimeslotMondayModel());
  }
