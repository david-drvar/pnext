...
import 'timeslot_tuesday_model.dart';
export 'timeslot_tuesday_model.dart';

class TimeslotTuesdayWidget extends StatefulWidget {
  const TimeslotTuesdayWidget({
    Key? key,
    this.newGarageRef,
  }) : super(key: key);
  ...
  @override
  _TimeslotTuesdayWidgetState createState() => _TimeslotTuesdayWidgetState();
}

class _TimeslotTuesdayWidgetState extends State<TimeslotTuesdayWidget> {
  late TimeslotTuesdayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimeslotTuesdayModel());
  }
