...
import 'timeslot_thursday_model.dart';
export 'timeslot_thursday_model.dart';

class TimeslotThursdayWidget extends StatefulWidget {
  const TimeslotThursdayWidget({
    Key? key,
    this.newGarageRef,
  }) : super(key: key);
  ...
  @override
  _TimeslotThursdayWidgetState createState() => _TimeslotThursdayWidgetState();
}

class _TimeslotThursdayWidgetState extends State<TimeslotThursdayWidget> {
  late TimeslotThursdayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimeslotThursdayModel());
  }
