...
import 'timeslot_friday_model.dart';
export 'timeslot_friday_model.dart';

class TimeslotFridayWidget extends StatefulWidget {
  const TimeslotFridayWidget({
    Key? key,
    this.newGarageRef,
  }) : super(key: key);
  ...
  @override
  _TimeslotFridayWidgetState createState() => _TimeslotFridayWidgetState();
}

class _TimeslotFridayWidgetState extends State<TimeslotFridayWidget> {
  late TimeslotFridayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimeslotFridayModel());
  }
